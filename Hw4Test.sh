...
do 
	...
	# Create the IR files
	java -classpath .:hw4/src/:resources/frontend.jar:resources/ir.jar X86GenDriver $F > $filename-1.s
	java -classpath .:hw4-sol/X86gen.jar:resources/frontend.jar:resources/ir.jar X86GenDriver $F > $filename-2.s
