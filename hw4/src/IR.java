...
class IR {
    ...
    static class Mem extends Operand {   // Memory at base + index
        final Operand base;   // must be Name or Temp
        final int index;
        Mem(Operand base, int index) {
            assert ((base instanceof Name) || (base instanceof Temp));
            this.base = base; this.index = index;
        }
        public boolean equals(Object l) {
            return (l instanceof Mem) &&
                    (((Mem) l).base.equals(base)) && (((Mem) l).index == index);
        }
        public int hashCode() {
            return base.hashCode() + index;
        }
    ...
    static class Arg extends Operand { // Outgoing call argument $Ai for call # c
        final int i;
        final int c;
        Arg(int i, int c) {
            this.i = i; this.c = c;
        ...
        public boolean equals(Object l) {
            return (l instanceof Arg) && (((Arg) l).i == i) && (((Arg) l).c == c);
        }
        public int hashCode() {
            return i + c;
        }
    ...
    static class Call extends Inst {
        ...
        final int c; // unique call # within this function
        Call(boolean is_system,Operand target,int arity,boolean returns_value, int c) {
            this.is_system = is_system; this.target = target;
            this.arity = arity; this.returns_value = returns_value;
            this.c = c;
        }
        public String toString() {
            return "call" + (is_system ? "s" : "") + "{" + c + "} " + "<" + arity + "," + returns_value + "> " + target;
        }
        Object accept(InstVisitor v) throws IRException {
            return v.visit(this);
        }
